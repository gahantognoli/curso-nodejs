...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/nodejs-part1$1.0.0/src/app/views/livros/form/formulario.marko",
...
function render(input, out, __component, component, state) {
  ...
  if (data.errosValidacao) {
    out.w("<div><div class=\"alert alert-danger\"><ul class=\"mb-0\">");
...
marko_template.meta = {
    id: "/nodejs-part1$1.0.0/src/app/views/livros/form/formulario.marko",
    tags: [
